...
const WhatsHappening = () => {
  ...
  return (
      <div className="pos-relative">
        <div className="row">
          <div className="col-1">
            <img alt="post logo" className="rounded-circle wd-avatar-45"
        ...
        <div className="row">
          ...
          <div className="col">
            <button
                className="mt-3 mb-3 btn btn-primary  rounded-pill fa-pull-right"
                onClick={() =>
                    createTuit(dispatch, newTuit)}>Tweet
            </button>
          </div>
